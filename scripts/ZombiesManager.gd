...
const zombieTypes = [preload("res://prefabs/zombies/zombie.tscn"), preload("res://prefabs/zombies/throwZombie.tscn"), preload("res://prefabs/zombies/babyZombie.tscn"), preload("res://prefabs/zombies/suckerZombie.tscn")]
